  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-white font-sans text-[#0b0b0c] antialiased">
      ...
      <section id="anfrage" className="relative isolate overflow-hidden bg-[#3797EE] text-white">
        ...
        <div className="mx-auto w-full max-w-lg px-5 pb-12 pt-5">
          <div className="flex items-center justify-between">
            <p className="text-[1.55rem] font-black leading-none tracking-[-0.06em] text-white">
              nüll<span className="text-white/50">.</span>
            </p>
            <a
              href="tel:+4915256569852"
              onClick={() => trackContactClick("kanzlei_meta_phone_click")}
              className="inline-flex h-10 items-center gap-2 rounded-full bg-white px-4 text-[0.8rem] font-bold text-[#3797EE] no-underline"
          ...
          <p className="mt-8 text-[0.66rem] font-black uppercase tracking-[0.18em] text-white/70">
            Für Kanzleien in Mannheim &amp; Heidelberg
          </p>
          <h1
            lang="de"
            className="mt-3 text-[clamp(2.05rem,8.5vw,2.9rem)] font-black leading-[1.02] tracking-[-0.04em] [text-wrap:balance]"
          >
            15 qualifizierte Mandats&shy;anfragen in 30&nbsp;Tagen.
            <span className="mt-2 block">
              <span className="bg-white px-2 py-0.5 text-[#3797EE]">Garantiert.</span>
            </span>
          </h1>
          <p className="mt-4 text-[0.98rem] font-medium leading-relaxed text-white/90">
            Der erste Monat ist kostenlos. Keine qualifizierten Anfragen – Sie steigen
            ohne Risiko wieder aus.
          </p>

          <div className="mt-6 rounded-2xl bg-white text-[#0b0b0c] shadow-[0_30px_60px_-18px_rgba(0,0,0,0.4)]">
            <div className="border-b border-[#eef0f3] px-5 pb-3 pt-4">
          ...
          <p className="mt-4 text-center text-[0.85rem] font-semibold text-white/85">
      ...
      <section className="bg-[#0b0b0c] text-white">
        <div className="mx-auto max-w-lg px-5 py-12">
          ...
          <div className="mt-7 grid grid-cols-2 gap-x-5 gap-y-8">
            {proofStats.map((stat) => (
              <div key={stat.label}>
                <p className="text-[1.9rem] font-black leading-none tracking-[-0.04em] text-[#3797EE]">
                  {stat.value}
                </p>
                <p className="mt-2 text-[0.8rem] font-semibold leading-snug text-white/70">
                  {stat.label}
                </p>
              </div>
            ))}
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-lg px-5 py-14">
          ...
          <h2 className="mt-3 text-[clamp(1.8rem,7vw,2.4rem)] font-black leading-[1.06] tracking-[-0.035em]">
            Ein System aus drei Teilen – nicht fünf lose Einzelkäufe.
          </h2>
          <p className="mt-4 text-[0.98rem] font-medium leading-relaxed text-[#4b5565]">
          ...
          <ol className="mt-10 space-y-3">
            {systemSteps.map((s, index) => (
              <li key={s.tag}>
                <article className="overflow-hidden rounded-2xl border border-[#e6e9ef]">
      ...
      <section className="bg-[#3797EE] text-white">
        <div className="mx-auto max-w-lg px-5 py-14">
          ...
          <p className="mt-4 text-[0.96rem] font-medium leading-relaxed text-white/90">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-lg px-5 py-14">
          ...
          <a
            ...
            className="mt-8 inline-flex h-[3.25rem] w-full items-center justify-center rounded-full bg-[#3797EE] px-6 text-[0.95rem] font-bold text-white no-underline"
          >
            Anfrage starten
      ...
      <section className="bg-[#f4f5f7]">
        <div className="mx-auto max-w-lg px-5 py-14">
          ...
          <div className="mt-8 divide-y divide-[#dfe3ea] border-y border-[#dfe3ea]">
            {faqItems.map((item) => (
              <details key={item.question} className="group py-4">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-[0.98rem] font-bold tracking-[-0.01em]">
                  {item.question}
                  <Plus className="h-5 w-5 shrink-0 text-[#3797EE] transition-transform duration-200 group-open:rotate-45" />
                </summary>
                <p className="mt-3 text-[0.94rem] font-medium leading-relaxed text-[#5b6472]">
                  {item.answer}
                </p>
              </details>
            ))}
      ...
      {/* ==================== Sticky CTA ==================== */}
      <div className="sticky bottom-0 z-40 border-t border-[#e6e9ef] bg-white/95 px-4 py-3 backdrop-blur">
        <a
          href="#anfrage"
