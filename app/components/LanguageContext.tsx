...
const labels: Record<string, Record<Language, string>> = {
  ...
  "pricing.retainer.intro": {
    ...
    tr: "Paketinize zaten dahil: Aylık €99 temel bakım. Daha fazlasını ister misiniz? İstediğiniz zaman yükseltin.",
  },
  "pricing.retainer.seo": { en: "SEO & CARE", de: "SEO & PFLEGE", tr: "SEO & PFLEGE" },
  "pricing.retainer.seo.badge": { en: "RECOMMENDED", de: "EMPFOHLEN", tr: "ÖNERİLEN" },
  "pricing.retainer.seo.desc": {
    ...
    tr: "Hukuk büronuz her ay Google arama sonuçlarında yükseliyor.",
  },
  "pricing.retainer.seo.f1": { en: "2 SEO blog articles per month", de: "2 SEO-Blogartikel pro Monat", tr: "Ayda 2 SEO blog makalesi" },
  "pricing.retainer.seo.f2": { en: "Keyword research for practice areas", de: "Keyword-Recherche für Ihre Rechtsgebiete", tr: "Hukuk alanlarınız için anahtar kelime araştırması" },
  ...
  "pricing.retainer.seo.f4": { en: "Technical SEO maintenance", de: "Technische SEO-Pflege", tr: "Teknik SEO bakımı" },
  "pricing.retainer.seo.f5": { en: "Monthly progress report", de: "Monatlicher Fortschrittsbericht", tr: "Aylık ilerleme raporu" },
  "pricing.retainer.seo.priceSuffix": { en: "/month", de: "/Monat", tr: "/ay" },

  "pricing.retainer.growth": { en: "GROWTH PACKAGE", de: "WACHSTUMS-PAKET", tr: "WACHSTUMS-PAKET" },
  "pricing.retainer.growth.desc": {
    ...
    tr: "SEO ve hukuk alanlarınız için müvekkil kazanan yeni açılış sayfaları.",
  },
  "pricing.retainer.growth.f1": { en: "Everything in SEO & care", de: "Alles aus SEO & Pflege", tr: "SEO ve bakımdaki her şey" },
  "pricing.retainer.growth.f2": { en: "New landing page every month", de: "Monatlich neue Landingpage", tr: "Her ay yeni açılış sayfası" },
  "pricing.retainer.growth.f3": { en: "Targeted by practice area or city", de: "Ausgerichteten auf Rechtsgebiet oder Stadt", tr: "Hukuk alanı veya şehre göre hedeflenmiş" },
  "pricing.retainer.growth.f4": { en: "Built to rank on Google", de: "Entwickelt um bei Google zu ranken", tr: "Google'da sıralanmak için tasarlanmış" },
  ...
  "pricing.retainer.disclaimer": {
    ...
    tr: "Aylık €99 temel bakım her web sitesi paketine dahildir ve ayrıca satın alınamaz.",
  },
  "pricing.cta.upgrade": { en: "Upgrade now", de: "Jetzt upgraden", tr: "Şimdi yükselt" },
  // Contact
