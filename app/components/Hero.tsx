  ...
  return (
    <section aria-label="Hero" className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-4 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-50/50 rounded-full blur-[120px] transition-opacity duration-1000" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.p
            ...
            className="text-[1.125rem] md:text-[1.25rem] text-slate-500 max-w-2xl mb-12 leading-relaxed"
          >
