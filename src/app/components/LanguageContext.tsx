...
const labels: Record<string, Record<Language, string>> = {
  ...
  "pricing.popular": { en: "Most Popular", de: "Meistgewählt", tr: "En Popüler" },
  ...
  "pricing.starter.desc": {
    ...
    tr: "Sağlam bir temel ile hızlı bir başlangıç.",
  },
  ...
  "pricing.growth.desc": {
    ...
    tr: "Müşteri kazandıran ve Google'da bulunan bir web sitesi.",
  },
  ...
  "pricing.premium.desc": {
    ...
    tr: "Rakiplerinden bir adım önde olmak isteyenler için.",
  },
  "pricing.starter.f1": { en: "One page, perfect on all devices", de: "Eine Seite, auf allen Geräten perfekt", tr: "Tek sayfa, tüm cihazlarda kusursuz" },
  "pricing.starter.f2": { en: "Individual design", de: "Individuelles Design", tr: "Özel tasarım" },
  ...
  "pricing.premium.f5": { en: "Texting assistance", de: "Unterstützung beim Texten", tr: "Metin desteği" },
